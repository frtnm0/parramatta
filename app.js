...
document.addEventListener('DOMContentLoaded', () => {
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            if (targetElement) {
                ...
                // Scroll with offset for both the sticky tabs bar and the dashboard nav bar
    ...
    // Handle initial hash in URL on page load (e.g. deep linking)
    ...
    if (initialHash) {
        ...
        if (targetElement) {
            ...
            // Scroll to it after a short timeout so elements are fully loaded
            setTimeout(() => {
                const tabsBarHeight = document.querySelector('.main-tabs-bar').offsetHeight || 51;
                const dashboardBarHeight = document.getElementById('dashboard-bar').offsetHeight || 80;
                const navBarHeight = tabsBarHeight + dashboardBarHeight;
    ...
    // ==========================================
    // 6. TAB CONTROLLER (WIKI GUIDE VS POWERSHELL SCRIPTS)
    // ==========================================
    ...
    if (tabBtnGuide && tabBtnScripts && tabPanelGuide && tabPanelScripts) {
        tabBtnGuide.addEventListener('click', () => switchTab('guide'));
    ...
    const embeddedScripts = {
        ...
        "AddTo-DLGroup.ps1": {
            ...
            content: ""
        },
        "users.csv": {
    ...
    // Attach click events to script sidebar buttons
    scriptNavButtons.forEach(btn => {
        btn.addEventListener('click', () => {
            scriptNavButtons.forEach(b => b.classList.remove('active'));
    ...
    function loadSelectedScript(scriptName) {
        ...
        // Update Description
        const desc = embeddedScripts[scriptName] ? embeddedScripts[scriptName].description : 'No description available.';
    ...
    function highlightPowerShell(code, fileName) {
        ...
        // Comments: # ...
        html = html.replace(/(^|[^"'])(#[^\n]*)/g, '$1<span class="pl-comment">$2</span>');

        // Strings: double quotes and single quotes
        html = html.replace(/(".*?")/g, '<span class="pl-string">$1</span>');
        html = html.replace(/('.*?')/g, '<span class="pl-string">$1</span>');

        // Variables: $var or $var.property
        html = html.replace(/(\$[a-zA-Z0-9_]+)/g, '<span class="pl-variable">$1</span>');

        // Cmdlets: Verb-Noun (e.g. Connect-MgGraph, Write-Host)
        html = html.replace(/\b([A-Z][a-z]+-[A-Z][a-zA-Z0-9_]+)\b/g, '<span class="pl-cmdlet">$1</span>');

        // Keywords: try, catch, finally, foreach, if, else
        const keywords = ['try', 'catch', 'finally', 'foreach', 'if', 'else', 'in', 'return', 'continue', 'break'];
        keywords.forEach(kw => {
            const regex = new RegExp(`\\b(${kw})\\b`, 'g');
            html = html.replace(regex, '<span class="pl-keyword">$1</span>');
        });
